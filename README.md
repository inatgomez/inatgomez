...
**Kinich Sports Performance** — Athlete-owned IP platform built on Story Protocol. Won the data track at Story's SWA Buildathon (Nov 2025). Explored what training context looks like as a data asset and how athletes can own the IP their performance generates.
...
`TypeScript` `React` `Python` `Blockchain / Story Protocol`
...
📓 [Writing on Substack](https://natgomez.substack.com) · 💼 [LinkedIn](https://www.linkedin.com/in/nat-gomez-162144331/)
